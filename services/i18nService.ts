...
export const translations = {
  ar: {
    ...
    tagline: 'صناعة الريادة بمنظور فاخر',
    subtitle: 'تمكين المشاريع الاستراتيجية بذكاء مؤسسي متكامل',
    common: { back: 'عودة' },
    nav: { home: 'الرئيسية', programs: 'البرامج', partners: 'الشركاء', contact: 'تواصل', login: 'دخول', start: 'ابدأ الرحلة' },
    hero: { title: 'صناعة الريادة\nبمنظور فاخر', sub: 'نخبة حاضنات الأعمال الرقمية، صممت للكيانات ذات الأثر الاستراتيجي العالي. ندمج الذكاء الاصطناعي الاستراتيجي مع الخبرة البشرية الرفيعة.', apply: 'تقديم الطلب', methodology: 'المنهجية' },
    stats: { startups: 'شركة محتضنة', capital: 'تمويل مستقطب', experts: 'خبير استراتيجي', countries: 'دولة مشاركة' },
    footer: { mission: 'تمكين المشاريع الاستراتيجية بذكاء مؤسسي متكامل.', rights: 'جميع الحقوق محفوظة.' },
    dashboard: {
      home: 'الرئيسية',
      bootcamp: 'المعسكر',
      tasks: 'المهام',
